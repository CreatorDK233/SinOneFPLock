...
//#define ProjectIs_BarLock_S1728		//583F 			指纹验证5次
//#define ProjectIs_BarLock_S1732		//383FM			指纹验证8次(同1728)(更换面板材质为亚克力)
//#define ProjectIs_BarLock_S6902		//贝特来  	指纹验证8次
//#define ProjectIs_BarLock_S8103		//贝特来  	指纹验证8次(同1728)
//#define ProjectIs_BarLock_S5514		//		内部rtc	 	指纹验证5次
...
#define DEF_HardwareVerion	201			//should be less than 256
...
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_Two,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_One,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
#define Function_ScreenDisplay
#define Function_DisplayUsed_HFG12864
...
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_Two,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_Three,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
#define Function_ScreenDisplay
#define Function_DisplayUsed_HFG12864
