...
#define ProjectIs_BarLock_S9022			//FJ04		指纹验证5次
...
#define DEF_FirmwareVerion	202		//should be less than 256
#define SystemHardwareVersion	{VOICE_Six,VOICE_Four,VOICE_Two,VOICE_Eight,DEF_VoiceSegmentEndFlag}
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_One,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_Two,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
//#define Function_ScreenDisplay
//#define Function_DisplayUsed_HFG12864
...
#define DEF_HardwareVerion	106		//should be less than 256
#define DEF_FirmwareVerion	206		//should be less than 256
#define SystemHardwareVersion	{VOICE_One,VOICE_Seven,VOICE_Three,VOICE_Four,DEF_VoiceSegmentEndFlag}
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_Six,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_Six,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
//#define Function_ScreenDisplay
//#define Function_DisplayUsed_HFG12864
...
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_Six,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_Four,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
//#define Function_ScreenDisplay
//#define Function_DisplayUsed_HFG12864
...
#define DEF_ModelNumber			22		//should be less than 256
#define DEF_HardwareVerion	100		//should be less than 256
#define DEF_FirmwareVerion	200		//should be less than 256
#define SystemHardwareVersion	{VOICE_Nine,VOICE_Zero,VOICE_Two,VOICE_Two,DEF_VoiceSegmentEndFlag}
#define SystemFirmwareVersion	{VOICE_One,VOICE_Zero,VOICE_Zero,VOICE_Mute20ms,VOICE_Two,VOICE_Zero,VOICE_Zero,DEF_VoiceSegmentEndFlag}
//#define Function_CardReaderUseSPI
#define Function_AppUnlock
//#define Function_ScreenDisplay
