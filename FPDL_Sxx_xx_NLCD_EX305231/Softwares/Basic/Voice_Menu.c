...
code uint8_t FpMenuVoiceBuff[][7] = {
	...
	{VOICE_Press, VOICE_Four, VOICE_ID, VOICE_Delete,VOICE_User,VOICE_Fingerprint, DEF_VoiceSegmentEndFlag},
#endif
...
#ifdef Function_Enable_ID_Del
  {VOICE_Press, VOICE_Four, VOICE_ID, VOICE_Delete,VOICE_User,VOICE_Password, DEF_VoiceSegmentEndFlag},
#endif
	{VOICE_PressAsteriskKey,VOICE_ReturnPreviousMenu,DEF_VoiceSegmentEndFlag}
};
...
#ifdef Function_Enable_ID_Del
  {VOICE_Press,VOICE_Three,VOICE_ID,VOICE_Delete,VOICE_Card,VOICE_User,DEF_VoiceSegmentEndFlag},
#endif
	{VOICE_PressAsteriskKey,VOICE_ReturnPreviousMenu,DEF_VoiceSegmentEndFlag}
};
...
//	{VOICE_Press,VOICE_One,VOICE_Time,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	...
	{VOICE_PressAsteriskKey,VOICE_ReturnPreviousMenu,DEF_VoiceSegmentEndFlag}
	#else
	{VOICE_Press,VOICE_One,VOICE_Voice,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	{VOICE_Press,VOICE_Two,VOICE_NormallyOpen,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	{VOICE_Press,VOICE_Three,VOICE_UnlockingMode,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	{VOICE_Press,VOICE_Four,VOICE_AntiSkidAlarm,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	{VOICE_Press,VOICE_Five,VOICE_RestoreFactoryDefault,VOICE_Setting,DEF_VoiceSegmentEndFlag},
	{VOICE_PressAsteriskKey,VOICE_ReturnPreviousMenu,DEF_VoiceSegmentEndFlag}
	#endif
};
