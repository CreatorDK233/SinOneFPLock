...
/*******************************************************/
/*******************************************************/
void ShowPasscodeMenu(void)//界面_密码菜单
{
	#ifdef Function_ScreenDisplay
	uint8_t i;
	for (i=0;i<3;i++)
...
/*******************************************************/
/*******************************************************/
void ShowCardUserMenu(void)//界面_磁卡菜单
{
	#ifdef Function_ScreenDisplay
	uint8_t i;
	for (i=0;i<2;i++)
...
/*******************************************************/
/*******************************************************/
void ShowSystemConfigMenu(void)//界面_系统配置菜单
{
	#ifdef Function_ScreenDisplay
	uint8_t i,j;
	if( VoiceMenuMgr.MenuPoint<5 )
...
/*******************************************************/
/*******************************************************/
void ShowRegisterMasterFp(void)//界面_注册管理员指纹
{
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
/*******************************************************/
void ShowDeleteMasterFp(void)//界面_删除管理员指纹
{
	//uint8_t i;
...
/*******************************************************/
/*******************************************************/
void ShowRegisterUserFp(void)//界面_注册用户指纹
{
	//uint8_t i;
	//uint16_t UserID;	
	//~{Lm<SV8NFSC;'~}
...
/*******************************************************/
/*******************************************************/
void ShowDeleteUserFp(void)//界面_删除用户指纹
{
	if ( FpUserDeleteMgr.Status == StartFpUserDelete )
	{
		FpUserDeleteMgr.Status = InputUserID;
...
/*******************************************************/
/*******************************************************/
void ShowDeleteAllUserFp(void)//界面_删除所有用户指纹
{
	uint16_t i;
...
/*******************************************************/
/*******************************************************/
void ShowDeleteCardUser(void)//界面_删除磁卡用户
{
...
/*******************************************************/
/*******************************************************/
void ShowDeleteAllCardUser(void)//界面_删除全部磁卡用户
{
...
/*******************************************************/
/*******************************************************/
void ShowDeletePasscodeUser(void)//界面_删除密码用户
{
...
/*******************************************************/
/*******************************************************/
void ShowDeleteAllPasscodeUser(void)//界面_删除全部密码用户
{
	//uint8_t i;
...
/*******************************************************/
/*******************************************************/
void ShowTimeSetting(void)//界面_时间设定
{
	#ifdef Function_ScreenDisplay
...
//uint8_t VoiceWait=0;
/*******************************************************/
void ShowVolumeSetting(void)//界面_音量设定
{	
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
/*******************************************************/
void ShowMemoryUsage(void)//界面_内存使用情况
{
...
/*******************************************************/
/*******************************************************/
void ShowManagerIdentify(void)//界面_管理员认证
{
	uint8_t i;
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
/*******************************************************/
void ShowUnlockingModeSetting(void)//界面_解锁模式设置
{
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
/*******************************************************/
void ShowPickAlarmEnableSetting(void)//界面_防撬告警使能设置
{
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
void ShowRestoreFactoryDefault(void)//界面_恢复出厂
{
	uint8_t i;
	#ifdef Function_ScreenDisplay
...
/*******************************************************/
/*******************************************************/
void ShowInitialization(void)//界面_初始化
{
...
/*******************************************************/
/*******************************************************/
void ShowSystemLocked(void)//界面_系统锁定
{
	#ifdef Function_ScreenDisplay
	uint16_t Temp;
...
#endif
void ShowPickLockAlarm(void)//界面_防撬告警
{
...
/*******************************************************/
/*******************************************************/
void ShowAgingTest(void)//界面_老化测试
{
	#ifdef Function_ScreenDisplay
...
void ShowEventLogBySequence(void)//界面_按顺序界面_事件日志
{
	#ifdef Function_EventLog
...
/*******************************************************/
/*******************************************************/
void ShowClearEventLog(void)//界面_清除事件日志
{
	#ifdef Function_EventLog
